...
parser.add_argument('--val_rgb', type=str, default="",
                    help='validate rgb path')
parser.add_argument('--val_depth', type=str, default="",
                    help='validate depth path')
parser.add_argument('--val_gt', type=str, default="",
...
def validate(test_dataset, model, epoch, opt):
    ...
    if epoch == 0:
        ...
        if mae < best_mae:
            ...
            best_epoch = epoch
            torch.save(model.state_dict(), opt.save_path + 'Net_mae_best.pth', _use_new_zipfile_serialization=False)
