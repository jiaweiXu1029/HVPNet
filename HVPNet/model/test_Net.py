...
parser.add_argument('--test_path', type=str, default='/home/jxnu/桌面/xjw/LCNet-main/Data/', help='test dataset path')
parser.add_argument('--save_path', type=str, default='./pre/', help='save path')
parser.add_argument('--pth_path', type=str, default='ckps/MAGNet/LCNet_mae_best.pth', help='checkpoint path')
...
test_datasets = ['DUTLF-Depth','LFSD','NJUD','NLPR','SIP','STERE']
