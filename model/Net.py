...
class Net(nn.Module):
    def __init__(self, pretrained=True,channel=32):
        ...
        self.rc1 = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=64, kernel_size=3, padding=1, stride=1, groups=1),
            nn.BatchNorm2d(64),
            nn.GELU(),
        ...
        self.rc2 = nn.Sequential(
            nn.Conv2d(in_channels=256, out_channels=128, kernel_size=3, padding=1, stride=1, groups=1),
            nn.BatchNorm2d(128),
            nn.GELU(),
        ...
        self.rc3 = nn.Sequential(
            nn.Conv2d(in_channels=512, out_channels=256, kernel_size=3, padding=1, stride=1, groups=1),
            nn.BatchNorm2d(256),
            nn.GELU(),
    ...
    def forward(self, x_rgb, x_d):
        ...
        fuse_4=self.upsample(fuse_4)
        fuse_4=self.rc3(fuse_4)
        fuse_3=fuse_4+fuse_3
        fuse_3=self.upsample(fuse_3)
        fuse_3 = self.rc2(fuse_3)
        fuse_2=fuse_3+fuse_2
        # Pred
